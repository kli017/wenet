...
class ConvolutionalGatingMLP(torch.nn.Module):
    ...
    #     xs_pad = x.transpose(1,2)
    #     # mask batch padding
    #     if mask_pad is not None:
    #         xs_pad.masked_fill_(~mask_pad, 0.0)
    ...
    #     out = xs_pad.transpose(1,2)

    #     if mask_pad is not None:
    #         out.masked_fill_(~mask_pad, 0.0)

    #     return out.transpose(1,2), new_cnn_cache
