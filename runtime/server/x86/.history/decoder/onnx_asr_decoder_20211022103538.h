...
class OnnxAsrDecoder {
 ...
 private:
  ...
  std::shared_ptr<OnnxAsrModel> modle_;
  ...
  std::vector<float> subsampling_cache_vector(256);
  std::vector<float> elayers_output_cache_vector(12*256);
  std::vector<float> conformer_cnn_cache_vector(12*256*15);
