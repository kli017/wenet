...
#include "third-party/onnx-1.9.0/include/session/onnxruntime_cxx_api.h"
#include "third-party/onnx-1.9.0/include/session/onnxruntime_run_options_config_keys.h"
...
private:
    void get_dims_and_names(std::shared_ptr<Ort::Session> session, 
