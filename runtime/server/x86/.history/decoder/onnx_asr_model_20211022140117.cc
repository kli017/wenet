...
void OnnxAsrModel::get_dims_and_names(Ort::Session* session,  
...
void OnnxAsrModel::Read(
    ...
    const int num_threads) {
        ...
        torch::jit::IValue o2 = model->run_method("right_context");
        CHECK_EQ(o2.isInt(), true);
        right_context_ = o2.toInt();
        torch::jit::IValue o3 = model->run_method("sos_symbol");
        CHECK_EQ(o3.isInt(), true);
        sos_ = o3.toInt();
        torch::jit::IValue o4 = model->run_method("eos_symbol");
        CHECK_EQ(o4.isInt(), true);
        eos_ = o4.toInt();
        torch::jit::IValue o5 = model->run_method("is_bidirectional_decoder");
