...
class OnnxAsrDecoder {
 ...
 private:
  ...
  Ort::Value InitNullCache(const std::vector<int64_t>& cache_dims);
  ...
  Ort::Value subsampling_cache_{static_cast<Ort::Value>(nullptr)};
  Ort::Value elayers_output_cache_{static_cast<Ort::Value>(nullptr)};
  Ort::Value conformer_cnn_cache_{static_cast<Ort::Value>(nullptr)};
